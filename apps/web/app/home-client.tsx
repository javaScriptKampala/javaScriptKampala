...
import type { Event, BlogPost, Sponsor, Project } from '../types';
...
const FeaturedEvent = ({ events }: { events: Event[] }) => {
...
export default function HomeClient({ events, blogPosts, sponsors, projects }: HomeClientProps) {
  return (
    <>
      <Hero />
      <MetricsStrip />
