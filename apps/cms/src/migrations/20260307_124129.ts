...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_cta_links_style" AS ENUM('primary', 'secondary', 'outline');
  CREATE TYPE "public"."enum_pages_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__pages_v_blocks_image_size" AS ENUM('full', 'medium', 'small');
  CREATE TYPE "public"."enum__pages_v_blocks_cta_links_style" AS ENUM('primary', 'secondary', 'outline');
  CREATE TYPE "public"."enum__pages_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_events_status" AS ENUM('upcoming', 'past');
  CREATE TYPE "public"."enum_sponsors_tier" AS ENUM('gold', 'silver', 'bronze', 'partner');
  CREATE TYPE "public"."enum_footer_social_links_platform" AS ENUM('twitter', 'github', 'linkedin', 'youtube', 'discord');
  ...
  CREATE TABLE "pages_blocks_cta_links" (
  	...
  	"label" varchar,
  	"url" varchar,
  	"style" "enum_pages_blocks_cta_links_style" DEFAULT 'primary'
  );
  ...
  CREATE TABLE "_pages_v_blocks_cta_links" (
  	...
  	"label" varchar,
  	"url" varchar,
  	"style" "enum__pages_v_blocks_cta_links_style" DEFAULT 'primary',
  	"_uuid" varchar
  );
  ...
  CREATE TABLE "events" (
  	...
  	"time" varchar,
  	"location_venue" varchar NOT NULL,
  ...
  CREATE TABLE "home" (
  	...
  	"featured_projects_heading" varchar DEFAULT 'Community Projects',
  	"sponsors_heading" varchar DEFAULT 'Our Sponsors',
  	"blog_heading" varchar DEFAULT 'Latest from the Blog',
  ...
  CREATE TABLE "footer" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"next_event_callout_enabled" boolean DEFAULT true,
  	"next_event_callout_heading" varchar DEFAULT 'Next Event',
  	"next_event_callout_description" varchar,
  	"copyright" varchar DEFAULT '© JavaScript Kampala. All rights reserved.',
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
  ...
  CREATE TABLE "site_settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"site_name" varchar DEFAULT 'JavaScript Kampala' NOT NULL,
  	"site_description" varchar DEFAULT 'The JavaScript Community in Kampala, Uganda',
  	"site_url" varchar DEFAULT 'https://jskla.dev',
  	"default_s_e_o_title" varchar DEFAULT 'JavaScript Kampala',
  	"default_s_e_o_description" varchar DEFAULT 'The JavaScript Community in Kampala, Uganda',
  	"default_s_e_o_og_image_id" integer,
  	"contact_email" varchar,
  	"newsletter_endpoint" varchar,
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
  ...
  ALTER TABLE "events_speakers" ADD CONSTRAINT "events_speakers_avatar_id_media_id_fk" FOREIGN KEY ("avatar_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "leaders" ADD CONSTRAINT "leaders_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "home" ADD CONSTRAINT "home_hero_background_video_id_media_id_fk" FOREIGN KEY ("hero_background_video_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "events_speakers_avatar_idx" ON "events_speakers" USING btree ("avatar_id");
  ...
  CREATE INDEX "leaders_image_idx" ON "leaders" USING btree ("image_id");
  ...
  CREATE INDEX "home_hero_hero_background_video_idx" ON "home" USING btree ("hero_background_video_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_pages_blocks_cta_links_style";
  DROP TYPE "public"."enum_pages_status";
  DROP TYPE "public"."enum__pages_v_blocks_image_size";
  DROP TYPE "public"."enum__pages_v_blocks_cta_links_style";
